                ...
                <div className="pt-2 border-t border-[var(--border-subtle)]">
                    <div className="flex gap-3">
                        <input
                            ...
                            className="flex-1 bg-[var(--surface-1)] border border-[var(--border)] rounded-xl px-4 py-3.5 text-[var(--text-primary)] placeholder-[var(--text-tertiary)] focus:outline-none focus:border-accent/50 text-[15px]"
                            autoFocus
                        />
                        <button
            ...
            <div className="pt-3 pb-2">
                <div className="flex gap-3">
                    <input
                        ...
                        className="flex-1 bg-[var(--surface-1)] border border-[var(--border)] rounded-xl px-4 py-3 text-[var(--text-primary)] placeholder-[var(--text-tertiary)] focus:outline-none focus:border-accent/50 text-[15px]"
                    />
                    <button
                        onClick={handleAddTopic}
                        disabled={!newTopicName.trim()}
                    ...
                    >
                        <Plus size={20} />
                        <span className="hidden sm:inline text-[13px] font-medium">Add</span>
                    </button>
                </div>
            </div>
        </div>
